# MFS Senior Software Engineer Interview Task
...
The server is hosted on a virtual machine on Digital ocean. You can make requests through the link [Link to API endpoint](api)
